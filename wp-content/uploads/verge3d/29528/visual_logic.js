 ...
 * Wed Feb 16 2022 15:28:01 GMT+0100 (Central European Standard Time)
...
_initGlob.output.initOptions.preloaderStartCb = function() {
    _initGlob.percentage = 0;
    (function() {
  setHTMLElemStyle('width', '0%', 'loader_inner', true);
  setHTMLElemStyle('display', 'inherit', 'loader_outer', true);
})();
};
_initGlob.output.initOptions.preloaderProgressCb = function(percentage) {
    _initGlob.percentage = percentage;
    (function() {
  setHTMLElemStyle('width', String(Math.round(_initGlob.percentage)) + '%', 'loader_inner', true);
})();
};
_initGlob.output.initOptions.preloaderEndCb = function() {
    _initGlob.percentage = 100;
    (function() {
  setHTMLElemStyle('display', 'none', 'loader_outer', true);
})();
};
...
registerOnClick('redball', false, false, [0,1,2], function() {
  setMaterialColor('red', 'Principled BSDF Color', 0.7, 0.2, 0.2, '');
}, function() {});

registerOnClick('blueball', false, false, [0,1,2], function() {
  setMaterialColor('red', 'Principled BSDF Color', 0.2, 0.2, 0.7, '');
}, function() {});
